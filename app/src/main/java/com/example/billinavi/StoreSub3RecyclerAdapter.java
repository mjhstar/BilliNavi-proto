...
public class StoreSub3RecyclerAdapter extends RecyclerView.Adapter<StoreSub3RecyclerAdapter.ItemViewHolder> {
    ...
    @NonNull
    @Override
    public StoreSub3RecyclerAdapter.ItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.lounge_sub4_item, parent, false);
        mContext = parent.getContext();
        return new StoreSub3RecyclerAdapter.ItemViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull StoreSub3RecyclerAdapter.ItemViewHolder holder, int position) {
